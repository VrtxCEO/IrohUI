const FILES = [
  { icon: '📄', name: 'io_wrapper.ts', meta: 'IrohOS Dev · in progress · 2.1kb' },
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
      <div className="content-panel">
        ...
        <div className="panel-sub">Outputs, files, and notes Iroh has produced. Ask Iroh to generate anything new.</div>
